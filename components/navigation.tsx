    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            AR
            <span className="absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-violet-400 to-cyan-400 scale-x-0 hover:scale-x-100 transition-transform duration-300 origin-left" />
          </Link>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-50 w-72 md:hidden flex flex-col bg-slate-950/95 backdrop-blur-xl border-l border-white/10 shadow-2xl"
            >
              {/* Drawer header */}
              ...
              <div className="px-6 py-6 border-t border-white/5">
                <a
                  href="#contact"
                  onClick={closeMobile}
                  className="shimmer-btn block w-full py-3 text-center bg-gradient-to-r from-violet-600 to-violet-500 text-white rounded-xl font-semibold text-sm hover:from-violet-500 hover:to-violet-400 transition-all duration-300"
                >
                  Let&apos;s Talk
                </a>
              </div>
